...
CONF = """
vserver!default!rule!directory!/allow1!allow_from = 99.99.99.99
vserver!default!rule!directory!/allow1!priority = 730
vserver!default!rule!directory!/allow1!final = 0
"""

...
CONF = """
vserver!default!directory!/privpam2!auth = pam
vserver!default!directory!/privpam2!auth!methods = basic
vserver!default!directory!/privpam2!auth!realm = Test PAM
vserver!default!directory!/privpam2!priority = 620
"""

...
CONF = """
vserver!default!rule!directory!/header_file1!handler = common
vserver!default!rule!directory!/header_file1!handler!notice_files = header
vserver!default!rule!directory!/header_file1!priority = 1130
"""

...
CONF = """
vserver!default!rule!1470!match!type = directory
vserver!default!rule!1470!match!directory = <dir>
vserver!default!rule!1470!handler = file
vserver!default!rule!1470!handler!iocache = 0
"""

...
CONF = """
vserver!default!rule!directory!/droot!handler = common
vserver!default!rule!directory!/droot!document_root = %s
vserver!default!rule!directory!/droot!priority = 630
"""

...
AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <pwd.h>
#include <stdlib.h>]], [[getpwnam_r(NULL,NULL,NULL,0,NULL);]])],[AC_DEFINE(HAVE_GETPWNAM_R_5,1,Some systems have getpwnam_r) AC_DEFINE(HAVE_GETPWNAM_R,1,
...
then
        ...
        AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <pwd.h>
#include <stdlib.h>]], [[getpwnam_r(NULL,NULL,NULL,0);]])],[AC_DEFINE(HAVE_GETPWNAM_R_4,1,Some systems have getpwnam_r) AC_DEFINE(HAVE_GETPWNAM_R,1,Some 
...
AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <pwd.h>
#include <stdlib.h>]], [[getpwuid_r(0,NULL,NULL,0,NULL);]])],[AC_DEFINE(HAVE_GETPWUID_R_5,1,Some systems have getpwuid_r) AC_DEFINE(HAVE_GETPWUID_R,1,Som
...
then
        ...
        AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <pwd.h>
#include <stdlib.h>]], [[getpwuid_r(0,NULL,NULL,0);]])],[AC_DEFINE(HAVE_GETPWUID_R_4,1,Some systems have getpwuid_r) AC_DEFINE(HAVE_GETPWUID_R,1,Some sys
...
AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <grp.h>
#include <stdlib.h>]], [[getgrnam_r(NULL,NULL,NULL,0,NULL);]])],[AC_DEFINE(HAVE_GETGRNAM_R_5,1,Some systems have getgrnam_r) AC_DEFINE(HAVE_GETGRNAM_R,1,
...
then
        ...
        AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <grp.h>
#include <stdlib.h>]], [[getgrnam_r(NULL,NULL,NULL,0);]])],[AC_DEFINE(HAVE_GETGRNAM_R_4,1,Some systems have getgrnam_r) AC_DEFINE(HAVE_GETGRNAM_R,1,Some 
...
AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <grp.h>
#include <stdlib.h>]], [[getgrgid_r(0,NULL,NULL,0,NULL);]])],[AC_DEFINE(HAVE_GETGRGID_R_5,1,Some systems have getgrgid_r) AC_DEFINE(HAVE_GETGRGID_R,1,Som
...
then
        ...
        AC_LINK_IFELSE([AC_LANG_PROGRAM([[#include <grp.h>
#include <stdlib.h>]], [[getgrgid_r(0,NULL,NULL,0);]])],[AC_DEFINE(HAVE_GETGRGID_R_4,1,Some systems have getgrgid_r) AC_DEFINE(HAVE_GETGRGID_R,1,Some sys

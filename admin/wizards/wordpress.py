...
%(pre_rule_minus1)s!match!fullpath!2 = %(web_dir)s/wp-admin/
...
%(pre_rule_minus2)s!match!fullpath!3 = /wp-admin/
...
CTK.publish ('^/wizard/vserver/wordpress/2$', PHP)
CTK.publish ('^/wizard/vserver/wordpress/3$', LocalSource)
CTK.publish ('^/wizard/vserver/wordpress/4$', Host)

# Rule
CTK.publish ('^/wizard/vserver/(\d+)/wordpress$',   Welcome)
CTK.publish ('^/wizard/vserver/(\d+)/wordpress/2$', PHP)
CTK.publish ('^/wizard/vserver/(\d+)/wordpress/3$', LocalSource)
CTK.publish ('^/wizard/vserver/(\d+)/wordpress/4$', WebDirectory)

...
CTK.publish ('^/wizard/vserver/symfony/2$', LocalSource)
CTK.publish ('^/wizard/vserver/symfony/3$', Host)

# Rule
CTK.publish ('^/wizard/vserver/(\d+)/symfony$',   Welcome)
CTK.publish ('^/wizard/vserver/(\d+)/symfony/2$', LocalSource)
CTK.publish ('^/wizard/vserver/(\d+)/symfony/3$', WebDirectory)

...
ret_t
cherokee_client_request_header_init (cherokee_client_request_header_t *request)
{
	ret_t ret;
...
ret_t
cherokee_client_request_header_mrproper (cherokee_client_request_header_t *request)
{
...
ret_t
cherokee_client_request_header_clean (cherokee_client_request_header_t *request)
{
	request->method    = http_get;
	request->version   = http_version_11;
	request->keepalive = true;
...
ret_t
cherokee_client_request_header_uses_proxy (cherokee_client_request_header_t *request, cherokee_boolean_t proxy)
{
	request->proxy = proxy;
	return ret_ok;
}
...
ret_t
cherokee_client_request_header_parse_string (cherokee_client_request_header_t *request, cherokee_buffer_t *url_string)
{
...
ret_t
cherokee_client_request_header_build_string (cherokee_client_request_header_t *request, cherokee_buffer_t *buf, cherokee_buffer_t *tmp1, cherokee_buffer_t *tmp2)
{
	ret_t           ret;
	const char     *ptr;
	cuint_t         len;
	cherokee_url_t *url = CLIENT_REQUEST_URL(request);
	...
	switch (CLIENT_REQUEST_VERSION(request)) {
	 ...
	 */
	if (CLIENT_REQUEST_VERSION(request) == http_version_11) {
	 ...
	 */
	if (CLIENT_REQUEST_KEEPALIVE(request)) {
...
ret_t
cherokee_client_request_header_set_auth (cherokee_client_request_header_t *request,
...
ret_t
cherokee_client_request_header_add_header (cherokee_client_request_header_t *request,
					   char                             *ptr,
					   cuint_t                           len)
{
